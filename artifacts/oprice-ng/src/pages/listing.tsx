          ...
          <div className="flex gap-3">
            ...
            {listing.whatsappNumber ? (
              <a
                ...
                className="flex-[2] py-4 rounded-2xl bg-green-500 text-white text-[15px] font-black shadow-xl shadow-green-500/25 hover:opacity-90 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
